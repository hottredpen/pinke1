...
class AdminDatabaseModel extends CommonModel{
    ...
    protected $_validate = array(
        ...
        array('tables', 'is_export_database_lock_pass', '检测到有一个备份任务正在执行，请稍后再试！', self::MUST_VALIDATE,'callback',self::ADMIN_ADD),
