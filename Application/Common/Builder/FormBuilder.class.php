...
class FormBuilder extends CommonBaseController {
     ...
     */
    public function setItemToGroup($item_name,$group_id,$group_title="", $item_col_data = array() ,$group_item_left_col_class,$group_item_right_col_class){
        ...
        foreach ($_arr as $key => $value) {
            foreach ($this->_form_items as $key2 => $value2) {
                if($value2['name'] == $value){
                    ...
                    $this->_form_items[$key2]['group_item_left_col_class']  = $group_item_left_col_class;
                    $this->_form_items[$key2]['group_item_right_col_class'] = $group_item_right_col_class;
     ...
     * 设置表单提交后的回掉地址
     */
    public function setPostBackUrl($post_backurl){
