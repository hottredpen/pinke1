...
gulp.task('admin_copy_components_to_script', function(){

	console.log('admin_copy_components_to_script start');
	...
	copyDir(app_path + "/static/components/builder", app_path + "/script/"+module_name_lower+"/module/components/builder", function (err) {  
	    if (err) {  
