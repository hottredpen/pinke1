...
$(function(){
    var set_h = function(){
        var heights = document.documentElement.clientHeight-59;
    ...
    $(document).on('click','.J_switchs',function(i){
    ...
    //更新缓存
    $(document).on('click','#J_flush_cache',function(){
    ...
    //后台地图
    $(document).on('click','#J_admin_map',function(){
        var title = $(this).attr('title');
    ...
    //左侧开关
    $(document).on('click','#J_lmoc',function(){
    ...
    //顶部菜单点击
    $(document).on('click','#J_tmenu a',function(){
        ...
        //hottredpen
        window.history.pushState({},0,'http://'+window.location.host+'/Admin/index/index/menuid/'+data_id);
    ...
    //左侧菜单点击
    $(document).on('click','.J_lmenu a',function(){
    ...
    //TAB点击
    $(document).on('click','#J_mtab li',function(){
    ...
    //上一个TAB
    $(document).on('click','#J_prev',function(){
        $('#J_mtab_h .current').prev().trigger('click');
    });

    //下一个TAB
    $(document).on('click','#J_next',function(){
        $('#J_mtab_h .current').next().trigger('click');
    });

    //关闭TAB
    $(document).on('click','#J_mtab_h a.del',function(){
