    ...
    self.clickToolbar(name, function () {
        var elements = [],
            ...
            html = '<div class="ke-plugin-emoticons">\
                    ...
                    <div id="tabIconReview"><img id="faceReview" class="review" src="' + path + '000.gif" /></div></div>\
                    </div>';
        ...
        initImgBox(faceBox['tab0'], 'j_00', 70);
        ...
        inforBox['tab0'] = ['Kiss', 'Love', 'Yeah', '啊！', '背扭', '顶', '抖胸', '88', '汗', '瞌睡', '鲁拉', '拍砖', '揉脸', '生日快乐', '大笑', '瀑布汗~', '惊讶', '臭美', '傻笑', '抛媚眼', '发怒', '打酱油', '俯卧撑', '气愤', '?', '吻', '怒', '胜利', 'HI', 'KISS', '不说', '不要', '扯花', '大心', '顶', '大惊', '飞吻', '鬼脸', '害羞', '口水', '狂哭', '来', '发财了', '吃西瓜', '套牢', '害羞', '庆祝', '我来了', '敲打', '晕了', '胜利', '臭美', '被打了', '贪吃', '迎接', '酷', '微笑', '亲吻', '调皮', '惊恐', '耍酷', '发火', '害羞', '汗水', '大哭', '', '加油', '困', '你NB', '晕倒'];
            ...
            for (; i < imgNum; ) {
                ...
                for (var j = 0; j < imgColNum; j++, i++) {
                    ...
                    if (faceImage) {
                        ...
                        textHTML.push('<img  style="background-position:left ' + offset + 'px;" title="' + infor + '" src="' + sBasePath + '000.gif" width="' + iWidth + '" height="' + iHeight + '"></img>');
                        textHTML.push('</span>');
                    } else {
...
KindEditor.plugin('preview', function(K) {
	...
	self.clickToolbar(name, function() {
		var lang = self.lang(name + '.'),
			html = '<div style="padding:10px 20px;">' +
				'<iframe class="ke-textarea" frameborder="0" style="width:1148px;height:400px;"></iframe>' +
				'</div>',
			dialog = self.createDialog({
				name : name,
				width : 1200,
